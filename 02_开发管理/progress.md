...
spec_version: 9
current_phase: Phase 1 — STM-009 committed
...
formal_STM-009_status: committed
...
formal_STM-009_p0: 0
formal_STM-009_p1: 0
formal_STM-009_note: "IMPLEMENTATION_RELEASE；Compression Coordinator + POST /api/v1/memory/working/message；STM-003–008 编排；FakeLlmClient 注入；Kafka publish_failed 继续 LLM；多轮 partial fail 不回滚；HEAD prefix cap-shrink；PR #28 OPEN；WAITING_FOR_PR_MERGE；OI-004 remains open"
...
**下游**：**STM-009** `committed` — PR [#28](https://github.com/xu-jia-ming/memory_system/pull/28) **OPEN**；implementation `1b6270b663b6326efb32f096a0e67e2742bb6794`；`next_action=WAITING_FOR_PR_MERGE`；**不得自动 merge**；**STM-010** NOT ready（needs STM-009 completed）；**STM-011** `READY_FOR_PLANNING only`；**不得触碰 DEV-006/PR#13**。
...
1. **STM-009**：`committed` — Compression Coordinator + `POST /api/v1/memory/working/message`；PR [#28](https://github.com/xu-jia-ming/memory_system/pull/28) **OPEN**；implementation `1b6270b663b6326efb32f096a0e67e2742bb6794`；scoped unit **21** / contract **10** / integration **12**；full unit **410** / contract **90**；ruff **PASS**；mypy **PASS**；`next_action=WAITING_FOR_PR_MERGE`；**不得自动 merge**；**不得触碰 DEV-006/PR#13**。
