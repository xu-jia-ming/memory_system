...
| E2E-001 | 全链路 E2E 与全部失败注入 | §3.28, §3.32 | OPS-003 | tested |
...
- **状态备注**：`tested`（plan `c2afaaa576107329ca6153a846fcb071c9383445`；feat `feat/E2E-001-full-chain-e2e-failure-injection`；E2E 11 passed / contract 3 passed / ruff PASS / mypy src 0；zero `src/**`；**非** completed；next_action=independent Code Review；不得触碰 DEV-006/PR#13）。
