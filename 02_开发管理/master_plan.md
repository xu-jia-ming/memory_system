...
| DEV-OPS-007 | Phase 1 Baseline Hygiene Before STM-006 | 非业务：STM-005 orphan SHA metadata 更正 + Ruff E501 torn-read helper 换行 | STM-005 | committed |
...
- **状态备注**：`committed`（implementation `1ef8932b87604de9a01dab72e7584a4e7886b155`；PR #24 OPEN；orphan SHA metadata 更正 → `b0736431…`；Ruff E501 L174–175 换行；integration 14 / unit 323 / contract 68；ruff PASS；mypy PASS；`next_action=WAITING_FOR_PR_MERGE`；**不得启动 STM-006 规划或实施**）。
